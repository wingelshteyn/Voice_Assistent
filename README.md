...
18. Добавить команду "Переведи на английский", которая будет переводить фразу пользователя и вставлять ее в буфер обмена.

---

### **Спринт 7: Интеграция нейросети**
13. Зарегистрироваться на платформе OpenRouter и получить API-ключ для доступа к нейросети.
