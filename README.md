...
8. Добавить команду "Открой браузер", которая открывает браузер по умолчанию с помощью модуля `webbrowser`.
9. Реализовать команду "Поиск в интернете", которая открывает браузер с поисковым запросом в Google.
